...
contracts.\levi{Claudio, I don't understand this sentence}
...
engine is fully homegrown and does not depend on third-party solvers. Despite
the large effort needed to build the codebase, we have been able to
