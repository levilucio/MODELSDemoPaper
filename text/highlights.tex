...
(infinite) set of computations that can be built by \cgg{Instead of ``can be built'', I suggest using ``can be expressed'' or ``can occur''. This is because computations are not built. They occur or they are expressed (I am not sure which).} a model transformation
