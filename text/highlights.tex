...
transform declarative ATL transformations\footnote{See ~\cite{Oakes} for an
extact account on which are the constructs of ATL that we can verify.} into our
transformation language DSLTrans. This allows the user to also prove contracts
on ATL transformations. Extending this capability to SyVOLT's user interface is
future work.
