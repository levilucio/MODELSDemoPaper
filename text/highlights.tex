...
transformation is around 20 rules. \levi{cite Manuel's paper??}.
...
transformation from the ATL
Zoo\footnote{http://www.eclipse.org/atl/atlTransformations/}~\cite{Oakes} show that contracts can be verified within seconds. In 

Gehan Selim's PhD thesis~\cite{Selim2015}
provides further evidence of SyVOLT's speed in verifying a relatively large model transformation
...
(EMF). To take advantage of this
ecosystem, SyVOLT integrates with EMF to represent models in a multitude of syntaxes, from
graphical to textual. The modeler may then operate in their preferred syntax.
