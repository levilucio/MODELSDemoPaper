...
model transformation being verified in a way that it represents executing the model transformation over any input
...
with EMF. In the EMF, models can be represented in a multitude of syntaxes, from
graphical to textual, and this makes the interaction with SyVOLT easier since the modeler
can use the model editor that is most convenient.
