...
The guiding principle of the McGill Unversity Modelling, Design, and Simulation Lab is that all
tools and processes should be explicitly modelled at an appropriate abstraction level.
This practice ensures that software development effort is targeted at essential complexity, rather than any accidental complexity in the domain.
...
\subsection*{2. Generating Artifacts for Proof Construction}
...
represent models and T-Core transformation rules. These classes will be loaded in memory and manipulated by the proof engine back-end.
...
\subsection*{3. Additional Generation of Model Transformations for Proof
Construction: The PyRamify Script}
...
Computing these subgraph isomorphisms is done by the property proof T-Core
