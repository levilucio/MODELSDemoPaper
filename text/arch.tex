...
contracts manipulated by the proof engine are models \cgg{Careful with this sentence because they already were models before SyVolt was invented. I suppose what you wanted to say here is that they \emph{are treated} as models by SyVolt prover.}. The representations of symbolic
...
In contrast, the domain model contains the abstract syntax: the essence of the elements that form the contracts and the propositional properties.
