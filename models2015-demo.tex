...
transformation language DSLTrans using a visual editor. The pre / post-
condition contracts to be proved on the transformation can also be built in a similar
